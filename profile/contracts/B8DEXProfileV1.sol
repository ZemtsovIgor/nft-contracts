...
import '../lib/IB8DEXProfile.sol';
import '../lib/IB8DToken.sol';

contract B8DEXProfileV1 is IB8DEXProfile, AccessControl, ERC721Holder {
    ...
    uint256 public numberB8DToReactivate;
    uint256 public numberB8DToRegister;
    uint256 public numberB8DToUpdate;
    ...
    constructor(
        IB8DToken _b8dToken,
        uint256 _numberB8DToReactivate,
        uint256 _numberB8DToRegister,
        uint256 _numberB8DToUpdate
    ) public {
        b8dToken = _b8dToken;
        numberB8DToReactivate = _numberB8DToReactivate;
        numberB8DToRegister = _numberB8DToRegister;
        numberB8DToUpdate = _numberB8DToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends B8D to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer B8D tokens to this contract
        b8dToken.transferFrom(_msgSender(), address(this), numberB8DToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer B8D token to this address
        b8dToken.transferFrom(_msgSender(), address(this), numberB8DToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        b8dToken.transferFrom(_msgSender(), address(this), numberB8DToReactivate);
    ...
    /**
     * @dev Update the number of B8D to register
     * Callable only by owner admins.
     */
    function updateNumberB8D(
        uint256 _newNumberB8DToReactivate,
        uint256 _newNumberB8DToRegister,
        uint256 _newNumberB8DToUpdate
    ) external onlyOwner {
        numberB8DToReactivate = _newNumberB8DToReactivate;
        numberB8DToRegister = _newNumberB8DToRegister;
        numberB8DToUpdate = _newNumberB8DToUpdate;
    }
